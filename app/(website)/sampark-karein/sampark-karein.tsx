              ...
              <div className="lg:col-span-2">
                <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-orange-100 h-full">
                  ...
                  <div className="p-8 pt-16">
                    <h2 className="text-3xl font-bold mb-8 text-gray-800">संपर्क जानकारी</h2>
                    ...
                    <div className="space-y-8">
                      ...
                      >
                        ...
                        <div>
                          <h3 className="font-medium text-gray-500 text-lg mb-1">फोन</h3>
                          <p className="text-gray-800 text-xl font-semibold">+91 98765 43210</p>
                        </div>
                      </motion.div>
                      ...
                      >
                        ...
                        <div>
                          <h3 className="font-medium text-gray-500 text-lg mb-1">ईमेल</h3>
                          <p className="text-gray-800 text-xl font-semibold">contact@manojtiwari.com</p>
                        </div>
                      </motion.div>
                      ...
                      >
                        ...
                        <div>
                          <h3 className="font-medium text-gray-500 text-lg mb-1">कार्यालय</h3>
                          <p className="text-gray-800 text-xl font-semibold">उत्तर पूर्वी दिल्ली संसदीय कार्यालय,<br />नई दिल्ली - 110001</p>
                        </div>
                      </motion.div>
                    </div>
                    
                    <div className="mt-12 pt-8 border-t border-gray-100">
                      <h3 className="font-medium text-gray-700 text-lg mb-6">हमें सोशल मीडिया पर फॉलो करें</h3>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      ...
                      <motion.div 
                        ...
                        transition={{ delay: 0.4 }}
                      >
                        <div className={`absolute left-5 ${focused.name ? 'top-3 text-xs' : 'top-1/2 -translate-y-1/2 text-base'} text-gray-500 transition-all pointer-events-none`}>
                        ...
                        <input
                          ...
                          className={`w-full bg-gray-50 border border-gray-200 rounded-xl px-5 ${focused.name ? 'pt-8 pb-3' : 'py-5'} text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all shadow-sm`}
                        />
                      </motion.div>
                      ...
                      <motion.div 
                        ...
                        transition={{ delay: 0.5 }}
                      >
                        <div className={`absolute left-5 ${focused.email ? 'top-3 text-xs' : 'top-1/2 -translate-y-1/2 text-base'} text-gray-500 transition-all pointer-events-none`}>
                        ...
                        <input
                          ...
                          className={`w-full bg-gray-50 border border-gray-200 rounded-xl px-5 ${focused.email ? 'pt-8 pb-3' : 'py-5'} text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all shadow-sm`}
                        />
                      </motion.div>
                      ...
                      <motion.div 
                        ...
                        transition={{ delay: 0.6 }}
                      >
                        <div className={`absolute left-5 ${focused.phone ? 'top-3 text-xs' : 'top-1/2 -translate-y-1/2 text-base'} text-gray-500 transition-all pointer-events-none`}>
                        ...
                        <input
                          ...
                          className={`w-full bg-gray-50 border border-gray-200 rounded-xl px-5 ${focused.phone ? 'pt-8 pb-3' : 'py-5'} text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all shadow-sm`}
                        />
                      </motion.div>
                      ...
                      >
                        <div className={`absolute left-5 ${focused.subject ? 'top-3 text-xs' : 'top-1/2 -translate-y-1/2 text-base'} text-gray-500 transition-all pointer-events-none`}>
                        ...
                        <input
                          ...
                          className={`w-full bg-gray-50 border border-gray-200 rounded-xl px-5 ${focused.subject ? 'pt-8 pb-3' : 'py-5'} text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all shadow-sm`}
                        />
                      </motion.div>
                    </div>
                    ...
                    >
                      <div className={`absolute left-5 ${focused.message ? 'top-3 text-xs' : 'top-7 text-base'} text-gray-500 transition-all pointer-events-none`}>
                        <MessageSquare className="w-5 h-5 inline mr-2" />
                        <span>संदेश</span>
                      </div>
                      <textarea
                        ...
                        rows={5}
                        className={`w-full bg-gray-50 border border-gray-200 rounded-xl px-5 ${focused.message ? 'pt-8 pb-3' : 'pt-7 pb-3'} text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all shadow-sm`}
                      ></textarea>
                    </motion.div>
