...
import { Phone, Mail, MapPin, Search, Briefcase, UserPlus, Users, X } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative bg-gradient-to-r from-orange-600 to-red-600 py-20">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <Image 
            src="/images/sampark-adhikari-bg.jpg" 
            alt="संपर्क अधिकारी" 
            fill 
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            >
              <h1 className="text-4xl md:text-6xl font-bold mb-4">संपर्क अधिकारी</h1>
              <p className="text-xl text-white/90 max-w-2xl mx-auto mb-8">
                मनोज तिवारी जी के कार्यालय के संपर्क अधिकारियों की सूची
              </p>
